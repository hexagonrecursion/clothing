...
for color, data in pairs(clothing.colors) do
  ...
  if data.hex2 then
	...
	minetest.register_craftitem("hades_clothing:skullcap_"..color, {
  ...
  if data.hex2 then
	...
	minetest.register_craftitem("hades_clothing:hood_mask_"..color, {
  ...
  if data.hex2 then
	...
	minetest.register_craftitem("hades_clothing:glove_right_"..color, {
  ...
  if data.hex2 then
	...
	minetest.register_craftitem("hades_clothing:glove_left_"..color, {
  ...
  if data.hex2 then
	...
	minetest.register_craftitem("hades_clothing:gloves_"..color, {
  ...
  if data.hex2 then
	...
	minetest.register_craftitem("hades_clothing:undershirt_"..color, {
  ...
  if data.hex2 then
	...
	minetest.register_craftitem("hades_clothing:shortshirt_"..color, {
  ...
  if data.hex2 then
	...
	minetest.register_craftitem("hades_clothing:shorts_"..color, {
