...
clothing.spinning_machine = appliances.appliance:new(
    {
      node_name_inactive = "hades_clothing:spinning_machine",
      node_name_active = "hades_clothing:spinning_machine_active",
...
spinning_machine:recipe_register_usage(
  "hades_clothing:yarn_spool_empty",
  {
    outputs = {""},
    consumption_time = 30,
...
if minetest.registered_items["hades_extrafarming:hemp_fibre"] then
  spinning_machine:recipe_register_input(
    ...
    {
      inputs = 1,
      outputs = {"hades_clothing:yarn_spool_white"},
      production_time = 30,
